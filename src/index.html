...
<body>
    ...
    <nav class="navbar fixed-top bg-info rounded-0 d-print-none">
        ...
        <div class="pull-right room-comm" hidden>
            <span class="text-white mr-5">Unique Identifier: <span id="randomNumber"></span></span>
            <button class="btn btn-sm rounded-0 btn-no-effect" id="toggle-video" title="Hide Video"><i class="fa fa-video text-white"></i></button>
            <button class="btn btn-sm rounded-0 btn-no-effect" id="toggle-mute" title="Mute"><i class="fa fa-microphone-alt text-white"></i></button>
            <button class="btn btn-sm rounded-0 btn-no-effect" id="share-screen" title="Share screen"><i class="fa fa-desktop text-white"></i></button>
            <button class="btn btn-sm rounded-0 btn-no-effect" id="record" title="Record"><i class="fa fa-dot-circle text-white"></i></button>
        ...
        <div class="row">
            ...
            <div class="col-md-3 chat-col d-print-none mb-2 bg-info" id="chat-pane" hidden>
                ...
                <div class="mb-3">
                    ...
                    <button class="btn btn-sm btn-dark" onclick="sendFile()">Send File</button>
